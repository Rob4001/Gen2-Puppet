...
SETTINGS = {
  :url          => "https://gemini-2.geeksoc.org",  # e.g. https://foreman.example.com
  ...
  :ssl_cert     => "/var/lib/puppet/ssl/certs/gemini-2.geeksoc.org.pem",    # e.g. /var/lib/puppet/ssl/certs/FQDN.pem
  :ssl_key      => "/var/lib/puppet/ssl/private_keys/gemini-2.geeksoc.org.pem"      # e.g. /var/lib/puppet/ssl/private_keys/FQDN.pem
}
